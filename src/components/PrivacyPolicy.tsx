      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-10 space-y-8 text-slate-600 dark:text-slate-300 leading-relaxed">
          ...
          <div className="space-y-4">
            ...
            <p>
              You can delete your account and all associated data at any time by going to <strong>User Profile → Delete My
              Account and Data</strong> in the App. This will permanently remove your data from our servers.
            </p>
